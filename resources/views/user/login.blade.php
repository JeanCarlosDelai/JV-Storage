                ...
                <div class="leading-loose">
                    <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                        ...
                        <div class="mt-4 items-center justify-between">
                            <input type="submit" value="Acessar" class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded">
                        </div>
                        <a class="inline-block right-0 align-baseline font-bold text-sm text-500 hover:text-blue-800" href="{{ route('user.create')}}">
                            Não está registrado?
                        </a>
                    </form>
